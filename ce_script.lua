...
local versions = {
    ["1.1.01 Hotfix 2 (Steam)"] = {
        globalDataHashMap = 0x1A1D450,
        arrayStageClearIndex = 0x19B63F8,
        arrayCometCoinIndex = 0x19B6378,
        arrayCometShardIndex = 0x19B6918,
        arrayMoonCoinsIndex = 0x19B7918,
        arrayCloudCoinsIndex = 0x19B7658
    },
    ["1.1.01 (GOG)"] = {
        globalDataHashMap = 0x1A26280,
        arrayStageClearIndex = 0x19BF3E8,
        arrayCometCoinIndex = 0x19BF338,
        arrayCometShardIndex = 0x19BF8F8,
        arrayMoonCoinsIndex = 0x19C08D8,
        arrayCloudCoinsIndex = 0x19C0648
    },
    ["1.1.01 Hotfix (Steam)"] = {
        globalDataHashMap = 0x1A1D450,
        arrayStageClearIndex = 0x19B63F8,
        arrayCometCoinIndex = 0x19B6358,
        arrayCometShardIndex = 0x19B6938,
        arrayMoonCoinsIndex = 0x19B7908,
        arrayCloudCoinsIndex = 0x19B7648
    },
    ["1.1.01 (Steam)"] = {
        globalDataHashMap = 0x1A1A360,
        arrayStageClearIndex = 0x19B33A8
    },
    ["1.1.0 (Steam)"] = {
        globalDataHashMap = 0x1A1A320,
        arrayStageClearIndex = 0x19B33A8
    },
    ["1.0.9.1 (Steam)"] = {
...
local selectedVersion = "1.1.01 Hotfix 2 (Steam)"
